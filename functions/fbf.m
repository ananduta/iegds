...
% 15/07/2021
        ...
        while 1
           ...
           for i=1:np.n
                ...
                nabx_L = gradx_L(np,s.u{i}(:,t),s.sigma_mg,s.lambda_mg,s.mu_tr,t,i);
            ...
            for i=1:np.n
                ...
                nabx_L_t = gradx_L(np,s.u_t{i}(:,t),s.sigma_mg_t,s.lambda_mg_t,s.mu_tr_t,t,i);
