...
%     end
    ...
    p.m.Aeq{i} = sparse([Aeq1;Aeq3;Aeq4]);
    p.m.beq{i} = sparse([beq1;beq3;beq4]);
...
%           -p.en.v_min(i)*ones(p.h,1)];
    ...
    p.m.bineq{i} = sparse([b1;b2;b3;b4;b5;b7;b8;bp]);
